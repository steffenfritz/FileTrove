...
func TestCreateFileList(t *testing.T) {
	...
	tests := []struct {
		...
		{"testdata file list", args{"testdata"}, []string{"testdata/.hiddenfile",
			"testdata/directory/A_PDF_File.pdf", "testdata/emptyfile.txt", "testdata/noaccess.rtf",
			"testdata/textfile.txt", "testdata/transparent.png", "testdata/white.jpg"},
			[]string{"testdata", "testdata/.hiddendir", "testdata/directory"}, false},
	}
